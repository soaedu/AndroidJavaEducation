 ...
 */
public class Lesson19_ShowDateExtended  extends     Activity
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            ...
            case R.id.Lesson19_ShowDate_ArrowBackWrapLL:    startActivity(new Intent(Lesson19_ShowDateExtended.this, Lesson19_IntentFilter.class));
                                                            break;
        }
    }
}