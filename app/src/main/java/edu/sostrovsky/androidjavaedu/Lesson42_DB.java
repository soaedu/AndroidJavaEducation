...
public class Lesson42_DB {

    private static final String DB_NAME = "mySimpleCursorTreeDB";
    ...
    private static final String PHONE_TABLE_CREATE = "create table " + PHONE_TABLE + "(" + PHONE_COLUMN_ID + " integer primary key autoincrement, " + PHONE_COLUMN_NAME + " text, "
    ...
    public Lesson42_DB(Context ctx) {
        mCtx = ctx;
    }
